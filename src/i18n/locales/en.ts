...
export default {
  "notifications": {
    ...
    "whisperAlignOn": "Whisper word alignment enabled",
    "whisperAlignOff": "Whisper word alignment disabled",
  ...
  "ui": {
    ...
    "forceRegenerateLyrics": "Regenerate Word-Level Lyrics",
  ...
  "whisperOverview": {
    ...
    "currentSong": "Current track: {{title}}",
    "noSong": "No track is playing",
    "timeline": "Per-line timeline",
    "timelineHint": "Expand a line to inspect its word-level timestamps",
    "noLyrics": "No lyrics loaded for the current track",
    "emptyLine": "(empty line)",
    "nWords": "{{count}} words",
    "noWords": "no words",
    "alignQuality": "Lyric confidence",
    "qualityExcellent": "Excellent",
    "qualityGood": "Good",
    "qualityFair": "Fair",
    "qualityPoor": "Poor",
    "qualityUnknown": "Not Whisper-aligned",
    "matchRate": "Token match rate",
    "matchRateHint": "Share of lyric characters/words Whisper actually matched. A low rate means the timeline is mostly interpolated rather than real timestamps.",
    "noDiagnostics": "These lyrics were not produced by a Whisper alignment run, so there is no confidence data yet. The structure stats below still apply.",
    "structure": "Structure",
    "lineCount": "Lines",
    "totalDuration": "Total duration",
    "avgLineDuration": "Avg line duration",
    ...
    "deletedTokens": "Untranscribed (interp)",
    "insertedTokens": "Extra (misheard)",
    "noAnchorLines": "No-anchor lines",
    "shiftLines": "Shift-calibrated",
    "boundaryLines": "Boundary re-spaced",
    ...
    "entryTitle": "Lyric Overview",
    "entryDesc": "Inspect the current track's per-line timeline and Whisper alignment quality."
  },
  "lyricFilter": {
  ...
  "options": {
    ...
    "clearWhisperCache": "Whisper alignment cache",
    "clearWhisperCacheDesc": "Delete every trace of Whisper alignment — the intermediate cache plus the word-by-word lyrics already written back to your library (including provider QRC/KRC/TTML). Those tracks re-fetch and re-align on the next play, so you can compare models or parameters. Imported lyrics and line-level sources are kept.",
    "clearWhisperCacheButton": "Clear all",
    "clearWhisperCacheClearing": "Clearing…",
    ...
    "whisperAlign": "Whisper Word Alignment",
    "whisperAlignDesc": "When word-by-word lyrics are unavailable, use Whisper AI to generate word-level timing from the audio. Requires whisper-cli and a model file.",
    "whisperAlignModel": "Whisper Model",
    "whisperAlignModelDesc": "Choose the Whisper model size. Larger models are more accurate but slower and use more memory.",
    "whisperAlignModelTiny": "Tiny (fastest, ~75MB)",
    "whisperAlignModelBase": "Base (fast, ~142MB)",
    "whisperAlignModelSmall": "Small (balanced, ~466MB)",
    "whisperAlignModelMedium": "Medium (accurate, ~1.5GB)",
    "whisperAlignModelLargeV3": "Large v3 (most accurate, multilingual, ~3.1GB)",
    "whisperAlignModelLargeV3Turbo": "Large v3 Turbo (accurate & fast, ~1.6GB)",
    "whisperAlignLanguage": "Transcription Language",
    "whisperAlignLanguageDesc": "The language Whisper transcribes in. Auto infers it from the lyric text (Chinese/Japanese/Korean); force a specific language for instrumental intros or mixed-language songs.",
    "whisperAlignLanguageAuto": "Auto (from lyrics)",
    "whisperAlignLanguageZh": "Chinese",
    "whisperAlignLanguageEn": "English",
    "whisperAlignLanguageJa": "Japanese",
    "whisperAlignLanguageKo": "Korean",
    "whisperAlignVocalSeparation": "Vocal Separation",
    "whisperAlignVocalSeparationDesc": "Isolate the vocals with HTDemucs before transcribing, so an instrumental intro or a loud backing track can't pull Whisper off the words. Processes the whole track and is slow; reuses Automix's HTDemucs model + Python runtime, and falls back to the full mix when they're missing or separation fails.",
    "whisperAlignVocalSeparationGpu": "GPU acceleration",
    "whisperAlignVocalSeparationGpuDesc": "Run HTDemucs on the GPU (CUDA). Needs the onnxruntime-gpu runtime plus system CUDA 12.8+/cuDNN 9.x; automatically falls back to the CPU when unavailable.",
    "whisperAlignVocalSeparationMissing": "Needs HTDemucs and its Python runtime. Download them in the Automix models section; alignment falls back to the full mix until they're ready.",
    "whisperAlignTrigger": "AI Word Align",
    "whisperAlignTriggerDesc": "Manually trigger Whisper word alignment for the current song.",
    "whisperAlignPreparing": "Preparing audio...",
    "whisperAlignTranscribing": "Transcribing with Whisper...",
    "whisperAlignAligning": "Aligning word timing...",
    "whisperAlignCompleted": "Word alignment completed",
    "whisperAlignError": "Word alignment failed: {{error}}",
    "whisperAlignCancelled": "Word alignment cancelled",
    "whisperAlignNoAudio": "Audio not available for this song. Ensure the file exists and the format is supported (install ffmpeg for automatic audio conversion)",
    "whisperAlignNoAudioLocal": "Local song file not available. Ensure the file exists and the format is supported",
    "whisperAlignNoAudioOnline": "Failed to fetch online song audio. Make sure you're logged in to the music platform and the song can play normally",
    "whisperAlignNoSegments": "Whisper transcription produced no results. Check that the audio contains speech content",
    "whisperAlignNotElectron": "Whisper word alignment is only available in the desktop version",
    "whisperAlignNotInstalled": "Whisper environment not ready. Please install whisper-cli and download a model.",
    "whisperAlignCliNotFound": "whisper-cli not found. Please install whisper.cpp.",
    "whisperAlignNoModel": "No Whisper model downloaded yet. Please download a model first.",
    "whisperAlignCheckError": "Failed to check Whisper status",
    "whisperAlignNotElectronTitle": "Desktop only",
    "whisperAlignNotElectronDesc": "Whisper word alignment requires the desktop (Electron) environment and is not available in the web version.",
    "whisperAlignCliNotFoundTitle": "whisper-cli not found",
    "whisperAlignCliNotFoundDesc": "Click the button below to automatically download and install whisper-cli, or manually install whisper.cpp and ensure whisper-cli is in your system PATH.",
    "whisperAlignNoModelTitle": "Model download required",
    "whisperAlignNoModelDesc": "Whisper is installed but no model has been downloaded yet. Click a button below to download a model file.",
    "whisperAlignModelDownloaded": "Downloaded",
    "whisperAlignModelDownloadError": "Download failed",
    "whisperAlignAutoInstall": "Auto-install whisper-cli",
    "whisperAlignInstallFetching": "Fetching latest release...",
    "whisperAlignInstallDownloading": "Downloading...",
    "whisperAlignInstallExtracting": "Extracting...",
    "whisperAlignInstallInstalling": "Installing...",
    "whisperAlignInstallDone": "whisper-cli installed successfully",
    "whisperAlignEnvChecking": "Checking environment...",
    "whisperAlignInstallRetry": "Retry",
    "whisperAlignFfmpegNotFoundTitle": "FFmpeg not found",
    "whisperAlignFfmpegNotFoundDesc": "FFmpeg is used to convert audio to WAV format for best Whisper transcription compatibility. Click the button below to auto-install, or add FFmpeg to your system PATH.",
    "whisperAlignFfmpegAutoInstall": "Auto-install FFmpeg",
    "whisperAlignFfmpegInstallPreparing": "Preparing...",
    "whisperAlignFfmpegInstallDownloading": "Downloading FFmpeg...",
    "whisperAlignFfmpegInstallExtracting": "Extracting...",
    "whisperAlignFfmpegInstallInstalling": "Installing...",
    "whisperAlignFfmpegInstallDone": "FFmpeg installed successfully",
    "whisperAlignFfmpegInstallRetry": "Retry",
    "lyricMatchPriority": "Lyric match priority",
    "lyricMatchPriorityDesc": "When multiple lyric sources have high-confidence matches, prefer this source first.",
  ...
  "localMusic": {
    ...
    "close": "Close",
    "whisperTabEnvStatus": "Environment Status",
    "whisperTabManualAlign": "Manual Alignment",
    "whisperTabAlreadyAligned": "Current lyrics already have word-level timing",
    "whisperTabNoLineTiming": "Current lyrics have no line timing, cannot align",
    "whisperTabCancel": "Cancel Alignment",
