...
export default {
  ...
  "options": {
    ...
    "whisperAlignCliNotFoundDesc": "Please install whisper.cpp and ensure whisper-cli is in your system PATH, or place it in the app's resources directory. Click the link below for installation instructions.",
