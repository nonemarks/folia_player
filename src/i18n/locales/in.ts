...
export default {
  ...
  "whisperOverview": {
    "title": "Ikhtisar Lirik",
    "currentSong": "Trek saat ini: {{title}}",
    "noSong": "Tidak ada trek yang diputar",
    "timeline": "Linimasa per baris",
    "timelineHint": "Bentangkan satu baris untuk melihat stempel waktu per kata",
    "noLyrics": "Tidak ada lirik yang dimuat untuk trek saat ini",
    "emptyLine": "(baris kosong)",
    "nWords": "{{count}} kata",
    "noWords": "tanpa kata",
    "alignQuality": "Keyakinan lirik",
    "qualityExcellent": "Sangat baik",
    "qualityGood": "Baik",
    "qualityFair": "Cukup",
    "qualityPoor": "Buruk",
    "qualityUnknown": "Bukan dijajarkan Whisper",
    "matchRate": "Tingkat kecocokan token",
    "matchRateHint": "Porsi karakter/kata lirik yang benar-benar dicocokkan Whisper. Tingkat yang rendah berarti linimasa sebagian besar diinterpolasi, bukan stempel waktu nyata.",
    "noDiagnostics": "Lirik ini tidak dihasilkan oleh proses penjajaran Whisper, jadi belum ada data keyakinan. Statistik struktur di bawah tetap berlaku.",
    "structure": "Struktur",
    "lineCount": "Baris",
    "totalDuration": "Durasi total",
    "avgLineDuration": "Rata-rata durasi baris",
    "totalWords": "Total kata",
    "avgWordsPerLine": "Rata-rata kata/baris",
    "wordByWord": "Kata demi kata",
    "yes": "Ya",
    "no": "Tidak",
    "diagnostics": "Diagnostik penjajaran",
    "matchedTokens": "Token cocok",
    "deletedTokens": "Tak ditranskrip (interp)",
    "insertedTokens": "Ekstra (salah dengar)",
    "noAnchorLines": "Baris tanpa jangkar",
    "shiftLines": "Dikalibrasi geser",
    "boundaryLines": "Jarak ulang batas",
    "globalOffset": "Offset global",
    "runInfo": "Info proses",
    "model": "Model",
    "language": "Bahasa",
    "segments": "Segmen",
    "alignedAt": "Dijajarkan pada",
    "entryTitle": "Ikhtisar Lirik",
    "entryDesc": "Periksa linimasa per baris dan kualitas penjajaran Whisper trek saat ini."
  },
  "lyricFilter": {
    "title": "Filter Lirik",
  ...
  "options": {
    ...
    "clearWhisperCache": "Cache penjajaran Whisper",
    "clearWhisperCacheDesc": "Hapus semua jejak penjajaran Whisper — cache sementara maupun lirik kata demi kata yang sudah ditulis kembali ke pustaka Anda (termasuk QRC/KRC/TTML dari provider). Lagu-lagu itu akan diambil dan dijajarkan ulang pada pemutaran berikutnya, sehingga Anda dapat membandingkan model atau parameter. Lirik yang diimpor dan sumber tingkat baris dipertahankan.",
    "clearWhisperCacheButton": "Hapus semua",
    "clearWhisperCacheClearing": "Menghapus…",
  ...
  "localMusic": {
    ...
    "close": "Tutup",
    "whisperTabEnvStatus": "Status Lingkungan",
    "whisperTabManualAlign": "Penyelarasan Manual",
    "whisperTabAlreadyAligned": "Lirik saat ini sudah memiliki waktu per kata",
    "whisperTabNoLineTiming": "Lirik saat ini tidak memiliki waktu per baris, tidak dapat menyelaraskan",
    "whisperTabCancel": "Batalkan Penyelarasan",
