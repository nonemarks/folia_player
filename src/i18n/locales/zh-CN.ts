...
export default {
  "notifications": {
    ...
    "whisperAlignOn": "Whisper 逐字对齐已开启",
    "whisperAlignOff": "Whisper 逐字对齐已关闭",
  ...
  "ui": {
    ...
    "forceRegenerateLyrics": "强制重新生成逐字歌词",
    "trashDislike": "删除 / 不喜欢"
  },
  "panel": {
    "cover": "封面",
  ...
  "whisperOverview": {
    "title": "歌词总览",
    "currentSong": "当前歌曲：{{title}}",
    "noSong": "当前未在播放",
    "timeline": "逐行时间轴",
    "timelineHint": "展开某一行可查看它的逐字时间戳",
    "noLyrics": "当前歌曲没有加载歌词",
    "emptyLine": "（空行）",
    "nWords": "{{count}} 字",
    "noWords": "无逐字",
    ...
    "qualityFair": "一般",
    "qualityPoor": "较差",
    "qualityUnknown": "非 Whisper 对齐",
    "matchRate": "文本匹配率",
    "matchRateHint": "歌词里被 Whisper 真正匹配到时间戳的字词比例。比例越低，说明时间轴越多是靠插值猜出来的，而非真实转录。",
    "noDiagnostics": "当前歌词不是 Whisper 对齐生成的，暂无置信度数据；下方的结构统计仍然有效。",
    "structure": "结构",
    "lineCount": "行数",
    "totalDuration": "总时长",
    "avgLineDuration": "平均行时长",
    "totalWords": "总字数",
    "avgWordsPerLine": "平均每行字数",
    "wordByWord": "逐字歌词",
    "yes": "是",
    "no": "否",
    "diagnostics": "对齐诊断",
    "matchedTokens": "匹配字词",
    "deletedTokens": "未转录（插值）",
    "insertedTokens": "多余（听错）",
    "noAnchorLines": "无锚点行",
    "shiftLines": "平移校正行",
    "boundaryLines": "边界重排行",
    "globalOffset": "整体偏移校正",
    ...
    "alignedAt": "对齐时间",
    "entryTitle": "歌词总览",
    "entryDesc": "查看当前歌曲的逐行时间轴与 Whisper 对齐质量。"
  },
  "lyricFilter": {
    "title": "歌词过滤",
  ...
  "options": {
    ...
    "clearWhisperCache": "Whisper 对齐缓存",
    "clearWhisperCacheDesc": "删除所有 Whisper 对齐痕迹——包括中间缓存，以及已写回歌词库的逐字歌词（含 QQ/酷狗的 QRC/KRC 等 provider 逐字）。这些歌下次播放会重新联网拉取并重新对齐，方便对比不同模型或参数的效果。手动导入的歌词和行级源歌词会保留。",
    "clearWhisperCacheButton": "全部清除",
    "clearWhisperCacheClearing": "清除中…",
    ...
    "whisperAlign": "Whisper 逐字对齐",
    "whisperAlignDesc": "当逐字歌词不可用时，使用 Whisper AI 根据音频生成逐字时间轴。需要 whisper-cli 和模型文件。",
    "whisperAlignModel": "Whisper 模型",
    "whisperAlignModelDesc": "选择 Whisper 模型大小。更大的模型更准确，但速度更慢、占用更多内存。",
    "whisperAlignModelTiny": "Tiny（最快，约 75MB）",
    "whisperAlignModelBase": "Base（快速，约 142MB）",
    "whisperAlignModelSmall": "Small（均衡，约 466MB）",
    "whisperAlignModelMedium": "Medium（准确，约 1.5GB）",
    "whisperAlignModelLargeV3": "Large v3（最准，多语言，约 3.1GB）",
    "whisperAlignModelLargeV3Turbo": "Large v3 Turbo（准且快，约 1.6GB）",
    "whisperAlignLanguage": "转录语言",
    "whisperAlignLanguageDesc": "Whisper 转录所用的语言。自动会根据歌词文本推断（中文/日语/韩语）；纯音乐前奏或中英混排的歌曲可强制指定语言。",
    "whisperAlignLanguageAuto": "自动（按歌词）",
    "whisperAlignLanguageZh": "中文",
    "whisperAlignLanguageEn": "英语",
    "whisperAlignLanguageJa": "日语",
    "whisperAlignLanguageKo": "韩语",
    "whisperAlignVocalSeparation": "人声分离",
    "whisperAlignVocalSeparationDesc": "转录前先用 HTDemucs 分离出人声，避免纯音乐前奏或过响的伴奏把 Whisper 带偏。会处理整首歌、耗时较长；复用 Automix 的 HTDemucs 模型 + Python 运行库，缺失或分离失败时自动回退到完整混音。",
    "whisperAlignVocalSeparationGpu": "GPU 加速",
    "whisperAlignVocalSeparationGpuDesc": "用 GPU（CUDA）运行 HTDemucs。需要 onnxruntime-gpu 运行库以及系统 CUDA 12.8+/cuDNN 9.x；不可用时自动回退 CPU。",
    "whisperAlignVocalSeparationMissing": "需要 HTDemucs 及其 Python 运行库。请在 Automix 模型区下载；就绪前对齐会自动回退到完整混音。",
    "whisperAlignTrigger": "AI 逐字对齐",
    "whisperAlignTriggerDesc": "手动触发 Whisper 逐字对齐当前歌曲。",
    "whisperAlignPreparing": "正在准备音频...",
    "whisperAlignTranscribing": "Whisper 转录中...",
    "whisperAlignAligning": "正在对齐逐字时间...",
    "whisperAlignCompleted": "逐字对齐完成",
    "whisperAlignError": "逐字对齐失败：{{error}}",
    "whisperAlignCancelled": "逐字对齐已取消",
    "whisperAlignNoAudio": "当前歌曲音频不可用，请确保歌曲文件存在且格式受支持（建议安装 ffmpeg 以自动转换音频格式）",
    "whisperAlignNoAudioLocal": "本地歌曲文件不可用，请确保文件存在且格式受支持",
    "whisperAlignNoAudioOnline": "在线歌曲音频获取失败，请确保已登录音乐平台且歌曲可正常播放",
    "whisperAlignNoSegments": "Whisper 转录未产生有效结果，请检查音频文件是否包含语音内容",
    "whisperAlignNotElectron": "Whisper 逐字对齐仅在桌面版中可用",
    "whisperAlignNotInstalled": "Whisper 环境未就绪，请安装 whisper-cli 并下载模型",
    "whisperAlignCliNotFound": "未找到 whisper-cli，请安装 whisper.cpp",
    "whisperAlignNoModel": "尚未下载 Whisper 模型，请先下载一个模型",
    "whisperAlignCheckError": "Whisper 状态检查失败",
    "whisperAlignNotElectronTitle": "仅桌面版可用",
    "whisperAlignNotElectronDesc": "Whisper 逐字对齐功能需要桌面版（Electron）环境，网页版暂不支持。",
    "whisperAlignCliNotFoundTitle": "未找到 whisper-cli",
    "whisperAlignCliNotFoundDesc": "点击下方按钮自动下载并安装 whisper-cli，或手动安装 whisper.cpp 并确保 whisper-cli 在系统 PATH 中。",
    "whisperAlignNoModelTitle": "需要下载模型",
    "whisperAlignNoModelDesc": "Whisper 已安装但尚未下载模型。请点击下方按钮下载一个模型文件。",
    "whisperAlignModelDownloaded": "已下载",
    "whisperAlignModelDownloadError": "下载失败",
    "whisperAlignAutoInstall": "自动安装 whisper-cli",
    "whisperAlignInstallFetching": "获取最新版本...",
    "whisperAlignInstallDownloading": "下载中...",
    "whisperAlignInstallExtracting": "解压中...",
    "whisperAlignInstallInstalling": "安装中...",
    "whisperAlignInstallDone": "whisper-cli 安装成功",
    "whisperAlignEnvChecking": "正在检测环境...",
    "whisperAlignInstallRetry": "重试",
    "whisperAlignFfmpegNotFoundTitle": "未找到 FFmpeg",
    "whisperAlignFfmpegNotFoundDesc": "FFmpeg 用于将音频转换为 WAV 格式，以获得最佳的 Whisper 转录兼容性。点击下方按钮自动安装，或将 FFmpeg 添加到系统 PATH。",
    "whisperAlignFfmpegAutoInstall": "自动安装 FFmpeg",
    "whisperAlignFfmpegInstallPreparing": "准备安装...",
    "whisperAlignFfmpegInstallDownloading": "下载 FFmpeg...",
    "whisperAlignFfmpegInstallExtracting": "解压中...",
    "whisperAlignFfmpegInstallInstalling": "安装中...",
    "whisperAlignFfmpegInstallDone": "FFmpeg 安装成功",
    "whisperAlignFfmpegInstallRetry": "重试",
    "lyricMatchPriority": "歌词匹配优先级",
  ...
  "localMusic": {
    ...
    "close": "关闭",
    "whisperTabEnvStatus": "环境状态",
    "whisperTabManualAlign": "手动对齐",
    "whisperTabAlreadyAligned": "当前歌词已包含逐字时间轴",
    "whisperTabNoLineTiming": "当前歌词无行级时间轴，无法进行逐字对齐",
    "whisperTabCancel": "取消对齐",
    "notALocalSong": "非本地歌曲",
    "fileInfo": "文件信息",
    "filename": "文件名",
