            ...
            <div className="contents sm:col-start-3 sm:row-start-1 sm:row-span-2 sm:flex sm:items-center sm:gap-1">
                ...
                {whisperAlignEnabled && onForceRegenerateLyrics && (
                    <button
                        ...
                        disabled={controlsDisabled || !slotContext.hasLyrics}
                        className={`rounded-full p-2 transition-colors sm:justify-self-auto ${!slotContext.hasLyrics || controlsDisabled ? 'cursor-not-allowed opacity-20' : `opacity-40 hover:opacity-100 ${isDaylight ? 'hover:bg-black/5' : 'hover:bg-white/10'}`}`}
